  ...
  >
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
          ...
          <div>
            <Field
              ...
              as="input"
              type="text"
              v-model="targets[index].severity"
    ...
    <div class="mb-4">
      ...
      <Field
        ...
        as="textarea"
        v-model="inScopeVulnerabilities"
        rows="4"
    ...
    <div class="mb-4">
      ...
      <Field
        ...
        as="textarea"
        v-model="outOfScopeVulnerabilities"
        rows="4"
