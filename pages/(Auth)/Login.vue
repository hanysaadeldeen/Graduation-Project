...
<template>
  <div class="relative h-dvh bg-gradient-to-t from-[#092034] to-[#09090B]">
    <img
      src="~/assets/img/loginPattern.svg"
      alt="LoginPatter"
      class="absolute -top-24 left-0 h-[700px] w-[1200px]"
      width="1200px"
      height="700px"
    />
    ...
    <div class="container relative mx-auto h-full px-4">
      <div class="flex items-center justify-center">
        <div
          class="relative h-fit w-full overflow-hidden rounded-xl py-10 md:w-[450px]"
        >
          <!-- الخلفية فقط -->
          <div class="absolute inset-0 z-0 bg-black/50 backdrop-blur-sm"></div>
          <h1
            class="relative z-10 mb-8 px-10 text-center text-xl text-white md:text-2xl"
          >
          ...
          <div class="relative z-10 px-10">
            ...
            >
              ...
              <div class="mb-4">
                <label
                  for="password"
                  class="inline-block cursor-pointer text-base font-semibold text-paragraph"
                  >Password</label
                >
                <Field
                  id="password"
            ...
            <span class="block w-full text-center text-paragraph">
              ...
              <nuxt-link
                ...
                class="tracking-wider text-white underline"
              >
                here
              </nuxt-link>
            </span>
